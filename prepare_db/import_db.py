...
def b_item_drug():
    ...
    VALUES (%s, %s)
    """
    df = pd.read_excel('HosOS_mock_data.xlsx', sheet_name='b_item_drug', dtype=str)
...
def t_visit():
    ...
    VALUES (%s, %s)
    """
    df = pd.read_excel('HosOS_mock_data.xlsx', sheet_name='t_visit', dtype=str)
...
def t_order():
    ...
    VALUES (%s, %s, %s)
    """
    df = pd.read_excel('HosOS_mock_data.xlsx', sheet_name='t_order', dtype=str)
...
def t_order_drug():
    ...
    VALUES (%s, %s, %s, %s)
    """
    df = pd.read_excel('HosOS_mock_data.xlsx', sheet_name='t_order_drug', dtype=str)
...
def t_patient_drug_allergy():
    ...
    VALUES (%s, %s, %s, %s)
    """
    df = pd.read_excel('HosOS_mock_data.xlsx', sheet_name='t_patient_drug_allergy', dtype=str)
    val = df.to_records(index=False)
    return sql, val
...
def b_icd10():
    ...
    VALUES (%s, %s)
    """
    df = pd.read_excel('HosOS_mock_data.xlsx', sheet_name='b_icd10', dtype=str)
    val = df.to_records(index=False)
    return sql, val
...
def t_diag_icd10():
    ...
    VALUES (%s, %s, %s, %s, %s)
    """
    df = pd.read_excel('HosOS_mock_data.xlsx', sheet_name='t_diag_icd10', dtype=str)
